...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-14 lg:px-22 xl:px-30 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      {
        open && (
          <div className={`${open ? 'flex' : 'hidden'} z-40 absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
